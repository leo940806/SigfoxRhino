...
#if defined(__ICCARM__) || defined(__IAR_SYSTEMS_ASM__)
__root __no_init const uint8_t nvm_data[FLASH_PAGE_SIZE] @0x08007080; /* Page 225 */
__root __no_init const uint8_t board_data[FLASH_PAGE_SIZE] @(0x08007080 - FLASH_PAGE_SIZE);  /* Page 224 */
#else
#ifdef __CC_ARM
const uint8_t nvm_data[FLASH_PAGE_SIZE] __attribute(( at(0x08007080), used, aligned(FLASH_PAGE_SIZE) )); /* Page 225 */		
const uint8_t board_data[FLASH_PAGE_SIZE] __attribute(( at(0x08007080 - FLASH_PAGE_SIZE), used, aligned(FLASH_PAGE_SIZE) ));	/* Page 224 */
#else
...
#if defined(__ICCARM__) || defined(__IAR_SYSTEMS_ASM__)
__root __no_init const uint8_t nvm_data[FLASH_PAGE_SIZE] @0x08000300; /* Page 3 */
__root __no_init const uint8_t board_data[FLASH_PAGE_SIZE] @(0x08000300 - FLASH_PAGE_SIZE);  /* Page 2 */
#else
#ifdef __CC_ARM
const uint8_t nvm_data[FLASH_PAGE_SIZE] __attribute(( at(0x08000300), used, aligned(FLASH_PAGE_SIZE) )); /* Page 3 */		
const uint8_t board_data[FLASH_PAGE_SIZE] __attribute(( at(0x08000300 - FLASH_PAGE_SIZE), used, aligned(FLASH_PAGE_SIZE) ));	/* Page 2 */
#else
...
#if defined(__ICCARM__) || defined(__IAR_SYSTEMS_ASM__)
__root __no_init const uint8_t nvm_data[FLASH_PAGE_SIZE] @0x08007000; /* Page 28 */
__root __no_init const uint8_t board_data[FLASH_PAGE_SIZE] @(0x08007000 - FLASH_PAGE_SIZE);  /* Page 27 */
#else
#ifdef __CC_ARM
const uint8_t nvm_data[FLASH_PAGE_SIZE] __attribute(( at(0x08007000), used, aligned(FLASH_PAGE_SIZE) )); /* Page 28 */		
const uint8_t board_data[FLASH_PAGE_SIZE] __attribute(( at(0x08007000 - FLASH_PAGE_SIZE), used, aligned(FLASH_PAGE_SIZE) ));	/* Page 27 */
#else
...
#if defined(__ICCARM__) || defined(__IAR_SYSTEMS_ASM__)
__root __no_init const uint8_t nvm_data[FLASH_PAGE_SIZE] @0x0800C000; /* Sector 2 */
__root __no_init const uint8_t board_data[FLASH_PAGE_SIZE] @(0x0800C000 - FLASH_PAGE_SIZE);	/* Sector 1 */
#else
#ifdef __CC_ARM
const uint8_t nvm_data[FLASH_PAGE_SIZE] __attribute(( at(0x0800C000), used )); /* Sector 2 */
const uint8_t board_data[FLASH_PAGE_SIZE] __attribute(( at(0x0800C000 - FLASH_PAGE_SIZE), used ));	/* Sector 1 */
#else
...
FLS_RW_StatusTypeDef FlashErase(uint32_t nAddress, uint32_t nPages)
{
  ...
  {
    error_code = HAL_FLASH_GetError();
    //printf("> ERROR WHILE ERASING PAGE: %d", error_code);
  }
