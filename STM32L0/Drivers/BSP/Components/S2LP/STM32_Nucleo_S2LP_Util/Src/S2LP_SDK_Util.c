...
* @brief This flag is used to synchronize the TIM3 ISR with the XtalMeasurement routine.
*/
static volatile uint8_t s_RfModuleBand = 0, s_Tcxo=1;
static volatile int32_t s_RfModuleOffset=0;
static volatile RangeExtType s_RangeExtType = RANGE_EXT_SKYWORKS_868;
...
//  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7, GPIO_PIN_SET);
	...
	__GPIOB_CLK_ENABLE();
  HAL_GPIO_Init(GPIOB, &(GPIO_InitTypeDef){GPIO_PIN_0, GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_HIGH });
