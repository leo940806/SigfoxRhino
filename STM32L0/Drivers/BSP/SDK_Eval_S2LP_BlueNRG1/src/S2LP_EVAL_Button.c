...
static const uint16_t s_vectnM2SButtonPin[S2LP_N_PLATFORMS][2] = {
  {IDB007_BUTTON1_PIN,IDB007_BUTTON2_PIN},
  {JORJIN_BUTTON_PIN,JORJIN_BUTTON_PIN},
};
...
uint32_t Get_ButtonGpioPin(SdkEvalButton xButton)
{
  ...
  return s_vectnM2SButtonPin[S2LPEvalGetVersion()][xButton];
}
