...
StatusBytes S2LPEvalSpiReadRegisters(uint8_t cRegAddress, uint8_t cNbBytes, uint8_t* pcBuffer);
StatusBytes S2LPEvalSpiReadRegisters(uint8_t cRegAddress, uint8_t cNbBytes, uint8_t* pcBuffer);
StatusBytes S2LPEvalSpiCommandStrobes(uint8_t cCommandCode);
StatusBytes S2LPEvalSpiWriteFifo(uint8_t cNbBytes, uint8_t* pcBuffer);
StatusBytes S2LPEvalSpiReadFifo(uint8_t cNbBytes, uint8_t* pcBuffer);
