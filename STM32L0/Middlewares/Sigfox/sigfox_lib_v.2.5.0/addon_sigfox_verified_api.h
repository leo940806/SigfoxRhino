...
/* ----------------------------------------------------------------------------- */
/* Bytes reserved for SIGFOX VERIFIED APP ERROR CODES : From 0xC0 to 0xDF        */
/* ----------------------------------------------------------------------------- */
...
#define SFX_VERIFIED_ERR_API_NVM                              (sfx_u8)(0xD0)
 ...
 *  matches with the payload sent by the certification tool.<BR>
 *  ______________________________________________________________________________________________
 *
...
/*!******************************************************************
 * \fn sfx_error_t ADDON_SIGFOX_VERIFIED_API_monarch_test_mode(sfx_rc_enum_t rc_enum, sfx_test_mode_t test_mode, sfx_u8 rc_capabilities)
 * \brief This function executes the \htmlonly <font color=red> MONARCH  </font> \endhtmlonly test modes needed for the Sigfox Verified Certification 
 * 
 *  ______________________________________________________________________________________________
 *
 ...
 *
 *******************************************************************/
sfx_error_t ADDON_SIGFOX_VERIFIED_API_monarch_test_mode(sfx_rc_enum_t rc_enum, sfx_test_mode_t test_mode, sfx_u8 rc_capabilities);
